...
@Configuration
@ComponentScan(basePackages = {"com.web.as.service"})
@ComponentScan(basePackages = {"com.web.as.aspect"})
@MapperScan(basePackages = {"com.web.as.persistence"})
...
//		config.setDriverClassName("com.mysql.cj.jdbc.Driver");// jdbc 드라이버 정보
//		config.setJdbcUrl("jdbc:mysql://localhost/AlternativeService?serverTimezone=UTC"); // DB 연결 url
		config.setUsername("DAEBOK"); // DB 사용자 아이디
		config.setPassword("5800"); // DB 사용자 비밀번호
